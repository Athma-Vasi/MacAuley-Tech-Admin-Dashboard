...
function createFinancialMetricsCharts({
  financialMetricsDocument,
  months,
  selectedDateFinancialMetrics,
...
function createDailyFinancialCharts({
  barChartsTemplate,
  dailyMetrics,
  lineChartsTemplate,
  ...
  pieChartsTemplate,
  selectedDayMetrics,
}: CreateDailyFinancialChartsInput): FinancialMetricsCharts["dailyCharts"] {
...
function createMonthlyFinancialCharts({
  barChartsTemplate,
  lineChartsTemplate,
  monthlyMetrics,
  otherMetricsBarChartsTemplate,
  ...
  selectedMonthMetrics,
  selectedYear,
}: CreateMonthlyFinancialChartsInput): FinancialMetricsCharts["monthlyCharts"] {
...
function createYearlyFinancialCharts({
  yearlyMetrics,
  selectedYearMetrics,
  pieChartsTemplate,
  otherMetricsLineChartsTemplate,
  ...
  lineChartsTemplate,
  barChartsTemplate,
}: CreateYearlyFinancialChartsInput): FinancialMetricsCharts["yearlyCharts"] {
...
function createFinancialMetricsCalendarCharts(
  calendarView: DashboardCalendarView,
  selectedDateFinancialMetrics: SelectedDateFinancialMetrics,
