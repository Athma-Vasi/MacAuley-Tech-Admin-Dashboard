...
function returnDailyOverviewCustomerMetrics(
  ...
  defaultValue.returningOverview.lifetimeValue = customerMetrics.lifetimeValue;
  ...
  defaultValue.newOverview.dailyNewCustomers = dailyMetrics.customers.new.total;
  defaultValue.returningOverview.dailyReturningCustomers =
    dailyMetrics.customers.returning.total;
  defaultValue.churnOverview.dailyChurnRate = dailyMetrics.customers.churnRate;
